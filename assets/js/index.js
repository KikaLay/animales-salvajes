...
const url = 'https://adrianaol.github.io/prueba_animales_salvajes/animales.json'
;(async () => {
  const request = async (url) => {
    ...
    button.addEventListener('click', () => {
      ...
      preview.innerHTML = `<img src='assets/imgs/${listadoAnimales[listadoAnimales.length-1].img}' class='h-100 w-75' style='object-fit: cover;'>`
      animales.innerHTML = ''
